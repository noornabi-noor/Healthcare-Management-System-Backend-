...
-- CreateEnum
CREATE TYPE "AppointmentStatus" AS ENUM ('SCHEDULED', 'INPROGRESS', 'COMPELETED', 'CANCELED');
...
CREATE TABLE "patient_health_data" (
    ...
    "hasBiabetes" BOOLEAN NOT NULL DEFAULT false,
    ...
    "recenAnxiety" BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE "doctor_schedules" (
    "doctorId" TEXT NOT NULL,
    "schduleId" TEXT NOT NULL,
    "isBooked" BOOLEAN NOT NULL DEFAULT false,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "doctor_schedules_pkey" PRIMARY KEY ("doctorId","schduleId")
);
...
-- CreateIndex
CREATE INDEX "doctor_schedules_schduleId_idx" ON "doctor_schedules"("schduleId");
...
-- AddForeignKey
ALTER TABLE "doctor_schedules" ADD CONSTRAINT "doctor_schedules_schduleId_fkey" FOREIGN KEY ("schduleId") REFERENCES "schedules"("id") ON DELETE CASCADE ON UPDATE CASCADE;
